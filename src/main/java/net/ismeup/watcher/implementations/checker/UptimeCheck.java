...
import net.ismeup.watcher.implementations.model.UptimeCheckOperationParameter;
import net.ismeup.watcher.implementations.model.UptimeCheckOperationResult;

...
import net.ismeup.watcher.implementations.model.MemoryCheckOperationResult;
import net.ismeup.watcher.implementations.model.MemoryCheckOperationParameter;
